...
ALTER TABLE locations ADD COLUMN IF NOT EXISTS start_at TEXT;
ALTER TABLE locations ADD COLUMN IF NOT EXISTS end_at TEXT;
...
-- Update the get_artist_by_booking_link function to include qr_code_url
