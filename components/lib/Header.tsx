...
export default function Header({ title, leftButtonImage, leftButtonTitle, rightButtonImage, rightButtonTitle, onLeftButtonPress, onRightButtonPress }: HeaderProps) {
    return (
        <View className="w-full h-20 flex-row items-center justify-between px-4 py-4">
            <Pressable onPress={onLeftButtonPress} className="items-center justify-center ">
