...
import { getAvailableDates, getAvailableTimes, createProjectSession } from "@/lib/services/booking-service";
...
export default function ClientAddSession() {
                            ...
                            <KeyboardAwareScrollView bottomOffset={50} showsVerticalScrollIndicator={false}>
                                <View className="gap-6 pb-6">
                                    <View className="items-center justify-center pb-[16px] h-[120px]">
                                        ...
                                        <Text variant="h6" className="text-center uppercase leading-none">Add Page</Text>
                                    </View>
