...
export default function ClientView() {
    ...
    const handleYourDatesScreen = () => {
        router.push('/artist/clients/view/your-dates');
    };

    const handleEmailExampleScreen = () => {
        router.push('/artist/clients/view/email-example');
    };

    const handleBookingFormScreen = () => {
        router.push('/artist/clients/view/booking-form');
    };
                            ...
                            <ScrollView contentContainerClassName="w-full" showsVerticalScrollIndicator={false}>
                                <View className="flex-1 bg-background px-4 pt-2 pb-8 gap-7">
                                    ...
                                    <View className="gap-4 flex-row justify-around">
                                        <Pressable className="flex-1 gap-6 max-w-[200px]" onPress={handleWelcomeScreen}>
                                        ...
                                        <Pressable className="flex-1 gap-6 max-w-[200px]" onPress={handleBookingScreen}>
