...
export default function AddTempChangePage() {
    ...
    const [formData, setFormData] = useState<TempChangeFormData>({
        start_date: null,
        end_date: null,
        work_days: [],
                        ...
                        >
                            <View className="gap-6 pb-6">
                                <View className="flex-row items-start gap-4">
                                    ...
                                    <Text variant="h4" className="leading-8 flex-1">Temporarily Change Your Work Days</Text>
                                </View>
