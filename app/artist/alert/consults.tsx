                            ...
                            <ScrollView contentContainerClassName="w-full" showsVerticalScrollIndicator={false}>
                                <View className="gap-6 pb-6">
                                    <View className="items-center justify-center pb-[22px] h-[180px]">
                                        ...
                                        <Text variant="h6" className="text-center uppercase leading-none">consult</Text>
                                        <Text className="text-center mt-2 text-text-secondary">New consult requests — decide</Text>
                                        <Text className="text-center text-text-secondary leading-none">when you're ready.</Text>
                                    </View>
